(()=>{
'use strict';
function load(src,id){if(document.getElementById(id))return;const s=document.createElement('script');s.id=id;s.src=src;s.defer=true;document.head.appendChild(s)}
function mount(){
  if(!document.getElementById('domScienceMethods')){
  ...
  load('./dom-earthscope-infrasound-live.js?v=20260914-1','domEarthScopeInfrasoundLoader');
  load('./dom-hazard-priority-completion.js?v=20260914-1','domHazardPriorityCompletionLoader');
}
