const DOMObservationHazardBridge=(()=>{
  ...
  return{toEvent,accept,stale,newer,kindMap,state:()=>({events:brokerEvents.size,historyVersions:historyVersions.size})};
})();