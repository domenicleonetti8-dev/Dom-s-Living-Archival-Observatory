(()=>{
  ...
  if(!window.DOMEarthVitals&&!document.querySelector('script[data-dom-earth-vitals]')){const s=document.createElement('script');s.src='./dom-earth-vitals.js?v=3';s.defer=true;s.dataset.domEarthVitals='1';document.body.appendChild(s)}
})();
