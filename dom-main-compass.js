(()=>{
  ...
  function render(status){
    const rose=$('#mainCompassRose'),value=$('#mainCompassHeading'),source=$('#mainCompassSource'),button=$('#mainCompassStart');
  ...
  window.DOMMainCompass=Object.freeze({start,headingFromEvent,cardinal,normalize:norm});
})();
