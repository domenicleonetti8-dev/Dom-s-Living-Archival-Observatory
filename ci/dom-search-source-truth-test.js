...
assert(audit.includes("src.state='REQUESTING'")&&audit.includes("src.state=response.ok?'RESPONDED':'UNAVAILABLE'")&&audit.includes("src.state='UNAVAILABLE'"),'browser request state is measured rather than assumed');
