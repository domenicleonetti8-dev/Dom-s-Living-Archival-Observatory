const DOMBrokerStatus=(()=>{
  ...
  function mountVisitor(){
    ...
    let box=document.getElementById('domVisitorCounter');if(!box){box=document.createElement('section');box.id='domVisitorCounter';box.className='hazard-card';box.style.marginTop='22px';box.setAttribute('aria-label','Visitor activity');box.innerHTML='<div class="status-row"><div><p class="eyebrow">PUBLIC OBSERVATORY ACTIVITY</p><h2 style="margin:.25rem 0">Visitors</h2></div><span class="tiny">privacy-preserving</span></div><div class="hazard-grid" style="margin-top:12px"><div class="hazard-card"><small>TOTAL VISITORS</small><strong id="domTotalVisitors" style="font-size:1.7rem">—</strong><span class="hazard-meta">anonymous browsers since counting began</span></div><div class="hazard-card"><small>LIVE NOW</small><strong id="domLiveVisitors" style="font-size:1.7rem">—</strong><span class="hazard-meta">active within the last ~2 minutes</span></div></div><div id="domVisitorState" class="tiny" aria-live="polite" style="margin-top:10px">Waiting for persistent visitor service…</div><div class="tiny" style="margin-top:6px">Counts are anonymous browser identifiers, not verified individual people. No IP history, location, names, or fingerprinting are stored by this counter.</div>';shell.appendChild(box)}render();return true
  }
