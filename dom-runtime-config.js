(()=>{
  ...
  const coreModules=[['./dom-geographic-semantic-forensic-audit.js?v=20260914-2','domGeographicSemanticForensicAudit'],['./dom-weather-climate-station-inspector.js?v=20260914-2','domWeatherClimateStationInspector'],['./dom-earthquake-visual-restoration.js?v=20260914-2','domEarthquakeVisualRestoration'],['./dom-geographic-hazard-motion.js?v=20260914-6','domGeographicHazardMotion'],['./dom-global-operational-weather-field.js?v=20260914-5','domGlobalOperationalWeather'],['./dom-wmo-gbon-station-supplement.js?v=20260914-1','domWmoGbonStations'],['./dom-global-coverage-gap-audit.js?v=20260914-2','domGlobalCoverageGapAudit']];
