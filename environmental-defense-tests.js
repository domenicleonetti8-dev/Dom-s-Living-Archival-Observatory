(()=>{
  ...
  try{
    ...
    const g=D.globalAreaWeightedMean([{lat:0,valueC:20,quality:1,coverage:1,uncertaintyC:.1},{lat:60,valueC:10,quality:1,coverage:1,uncertaintyC:.1}]);
    t('area weighting favors equator',g.valueC>15);
    t('global coverage bounded',g.coverage>=0&&g.coverage<=1);
