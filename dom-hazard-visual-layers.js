...
function attach(m,ml){map=m;maplibre=ml;ensure();map.on('zoomend',applyLazy);map.on('moveend',applyLazy);refreshNHC();if(nhcTimer)clearInterval(nhcTimer);nhcTimer=setInterval(refreshNHC,120000)}
