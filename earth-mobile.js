...
function initializeLoadedMap(){
 ...
 setState('Geographical Earth · satellite geography restored · stable spherical globe · build 0718.');
}
function build(){
 setState('Starting stable Geographical Earth…');
 try{
...
function refresh(){if(!map)return;setState('Refreshing geographic Earth…');map.triggerRepaint();setTimeout(()=>setState('Geographical Earth · satellite geography restored · stable spherical globe · build 0718.'),250);}
